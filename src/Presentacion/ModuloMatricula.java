...
public class ModuloMatricula extends javax.swing.JFrame {
    ...
    private void BotonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarActionPerformed
        ...
        try {
            Estudiante estudiante = negocioEstudiante.consultar(jTextFieldCedula.getText());
            
            jTextFieldNombre.setText(estudiante.getNombre());
            jTextFieldApellido.setText(estudiante.getApellido());
            jTextFieldCarrera.setText(estudiante.getCarrera());
            jTextFieldPromedio.setText(valueOf(estudiante.getPromedio()));
        } catch (Excepcion ex) {
            Logger.getLogger(ModuloMatricula.class.getName()).log(Level.SEVERE, null, ex);
        }
